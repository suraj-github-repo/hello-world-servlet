...
// for display purposes
      ...
      git 'https://github.com/suraj-github-repo/hello-world-servlet.git'
...
post {
        success {
            mail to:"meshrams063@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
